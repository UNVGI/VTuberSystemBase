...
{
    /// <summary>
    /// In-memory <see cref="IAsyncAssetLoader"/> double for stage-lighting-volume-tab
    /// tests. Resolves immediately from registered success / failure tables and tracks
    /// scope releases. (Task 1.2, Requirement 12.6)
    /// </summary>
