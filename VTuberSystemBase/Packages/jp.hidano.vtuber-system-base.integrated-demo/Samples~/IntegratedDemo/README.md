...
- 以下 9 パッケージがプロジェクトに追加されている (manifest.json)：
  ...
  - `jp.hidano.vtuber-system-base.rac-main-output-adapter`
  - `jp.hidano.vtuber-system-base.stage-lighting-volume-output-adapter`
  - `jp.hidano.vtuber-system-base.camera-switcher-output-adapter`
  - `jp.hidano.vtuber-system-base.integrated-demo` (本パッケージ)
